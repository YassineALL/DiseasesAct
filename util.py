...
#desc = pd.read_csv("D:/actimi/deployment/PredictDiseases/server/symptom_Description (1).csv" , sep=';',encoding='cp1252')
desc = pd.read_excel("D:/actimi/deployment/PredictDiseases/server/symptom_Description.xlsx")
#prec = pd.read_excel("D:/actimi/deployment/PredictDiseases/server/symptom_precaution.csv", sep=';',encoding='cp1252')
...
def predict_disease(S1,S2,S3,S4,S5=0,S6=0):
    ...
    print(pred2[0])
    return ("predict_disease : ",pred2[0])
